...
def get_next_location(current_state, action_index, n_episode):
    ...
    if random_num > 0.01:
        # With 99% probability, take the intended action
        if action_index == UP and current_row_index > 0:
            new_row_index -= 1
        elif action_index == RIGHT and current_column_index < environment_columns - 1:
            new_column_index += 1
        ...
        if random_action == UP and current_row_index > 0:
            print('\nUP was selected!')
            new_row_index -= 1
        elif random_action == RIGHT and current_column_index < environment_columns - 1:
            print('\nRIGHT was selected!')
            new_column_index += 1
